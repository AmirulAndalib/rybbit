...
/**
 * Fetches page data from Google Search Console API
 */
export async function getGSCPages(req: FastifyRequest<GetGSCDataRequest>, res: FastifyReply) {
  try {
    ...
    return res.status(500).send({ error: "Failed to fetch GSC pages" });
  }
}
